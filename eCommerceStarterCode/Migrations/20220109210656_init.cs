...
namespace eCommerceStarterCode.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Description", "GenresId", "ImageName", "Name", "Price", "UserId" },
                values: new object[,]
                {
                    { 1, "xxx", 1, null, "Oklahoma", 50m, null },
                    { 4, "xxx", 1, null, "Snatch", 54m, null },
                    { 2, "xxx", 2, null, "Happy Gilmore", 51m, null },
                    { 3, "xxx", 3, null, "Love: After Lockup", 53m, null },
                    { 5, "xxx", 3, null, "The Parent Trap", 50m, null }
                });
